...
- Equal-height split sidebar: inferred Progress above run Activity, a Paddock-oriented four-turn oval, response performance, auto-mode decisions, tool history, and permission provenance
